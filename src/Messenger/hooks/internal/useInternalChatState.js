...
const useInternalChatState = (dependencies) => {
  const { t, currentUser, currentChannel, setCurrentChannel, selectedOwner } =
    dependencies;
  ...
  const [channelListQuery, setChannelListQuery] = useState({
    channelListQuery: {
      ...
      includeEmpty: true,
      customTypesFilter: [constants.chat.internal],
  ...
  }, [sdk, currentChannel, selectedOwner]);
...
export default useInternalChatState;
