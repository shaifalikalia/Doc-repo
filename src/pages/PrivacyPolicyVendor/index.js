...
const PrivacyPolicyVendor = (props) => {
  useEffect(() => {
    window.scrollTo(0, 0);
    props.getConent({ id: constants.cmsPageKey.PrivacyPolicyForVendor });
  ...
  return (
    <div className="static-page-content">
      <div className="container">
        <h2 className="title">{t("privacyPolicyVendor")}</h2>
        {props.pageContent && (
          <div
...
export default connect(mapStateToProps, { getConent })(
  _isLoading(withTranslation()(PrivacyPolicyVendor))
);
