...
const CADPrice = ({ t, editSubscriptionPath, details }) => {
  return (
              ...
              <div className={styles["inner-left"]}>
                ...
                <ul>
                  <li>
                    ...
                    <span>{details?.setupFeeChargeInCad}</span>
                  </li>
                  <li>
                    <label>{t("superAdmin.officeCharges")}</label>
                    <span>{details?.perOfficeChargeInCad}</span>
                  </li>
                  <li>
                    <label>{t("superAdmin.permanentStaffCharges")}</label>
                    <span>{details?.perPermanentStaffMemberChargeInCad}</span>
                  </li>
                  <li>
                    <label>{t("superAdmin.temporaryStaffCharges")}</label>
                    <span>{details?.perTemporaryStaffMemberChargeInCad}</span>
                  </li>

                  <li className={styles["last-child"]}>
                    <label>{t("superAdmin.perEachPlacement")}</label>
                    <span>{details?.perPlacementChangeInCad}</span>
                  </li>
                </ul>
              </div>
            </Col>
            <Col md="6" className={styles["right-container"]}>
              <div className={styles["inner-right"] + " " + "px-0"}>
                ...
                <ul>
                  <li>
                    <label>{t("superAdmin.setUpFree")}</label>
                    <span>{details?.multiplesetupFeeChargeInCad}</span>
                  </li>
                  <li>
                    <label>{t("superAdmin.officeCharges")}</label>
                    <span>{details?.multipleperOfficeChargeInCad}</span>
                  </li>
                  <li>
                    <label>{t("superAdmin.permanentStaffCharges")}</label>
                    <span>
                      {details?.multipleperPermanentStaffMemberChargeInCad}
                    </span>
                  </li>
                  <li>
                    <label>{t("superAdmin.temporaryStaffCharges")}</label>
                    <span>
                      {details?.multipleperTemporaryStaffMemberChargeInCad}
                    </span>
                  </li>

                  <li className={styles["last-child"]}>
                    <label>{t("superAdmin.perEachPlacement")}</label>
                    <span>{details?.multipleperPlacementChangeInCad}</span>
                  </li>
                </ul>
              </div>
            </Col>
...
export default withTranslation()(CADPrice);
