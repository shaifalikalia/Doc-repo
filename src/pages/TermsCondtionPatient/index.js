...
const TermsCondtionPatient = (props) => {
  useEffect(() => {
    window.scrollTo(0, 0);
    props.getConent({ id: constants.cmsPageKey.TermsAndConditionsForPatient });
  ...
  return (
    <div className="static-page-content">
      <div className="container">
        <h2 className="title">{t("termsAndConditionsPatient")}</h2>
        {props.pageContent && (
          <div
...
export default connect(mapStateToProps, { getConent })(
  _isLoading(withTranslation()(TermsCondtionPatient))
);
